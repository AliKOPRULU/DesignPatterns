...
{//http://www.buraksenyurt.com/post/Tasarc4b1m-Desenleri-Mediator.aspx
    class MediatorAirport
    {
        public static void Main(string[] args)
        {
            ...
            zy99.RequestNewWat("34:43E;41:41W");

            oh101.RequestNewWat("34:43E;41:41W");
    ...
    class IstanbulControl : IAirportControl
    {
        ...
        //Kontrol kulesine çevredeki uçakların kayıt olması için Register metodu kullanılır. Bu metod parametre olarak Colleague' den türeyen her hangibir Concrete Colleague nesne örneğini alabilir.
        ...
        //Concrete Colleague nesne örneklerinin yeni rota talep ederken kullandıkları metod. Bu metod o anki koşullar gereği sakladığı diğer uçakların konum bilgilerinden yararlanıp bir takım sonuçlara
        //varmaktadır. Bu sayede n tane kombinasyonun, her bir uçak tarafından ele alınması yerine, tüm bu kombinasyonlar daha az sayıya indirgenerek Mediator içerisinde değerlendirilebilmektedir.
        public void SuggestWay(string flightNumber, string way)
        {
            ...
            _planes[flightNumber].GetWay(String.Format("{0}:{1}E;{2}:{3}W", rnd.Next(1, 100).ToString(), rnd.Next(1, 100).ToString(), rnd.Next(1, 100).ToString(), rnd.Next(1, 100).ToString()));
        }
