...
namespace DesignPatterns.BehavioralPatterns.State
{
    class StateDeposit
    {
        ...
        {
            // Open a new account
            Account account = new Account("Ali KÖPRÜLÜ");
    ...
    abstract class State
    {
        ...
        protected double interest;//faiz 
        ...
        public abstract void Withdraw(double amount);//çekilen
        public abstract void PayInterest();//faiz ödemesi
    }

    // A 'ConcreteState' class
    // Red indicates that account is overdrawn // hesabın aşırı çekildiği anlamına gelir
